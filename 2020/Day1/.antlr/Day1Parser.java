// Generated from /Users/etiennecosta/Desktop/AOC/Day1/Day1.g4 by ANTLR 4.8
				...
				_la = _input.LA(1);
			                                    ...
			                                    for(int i= 0 ; i<size;i++){
			                                        ...
			                                        for(int j = i+1 ; j <size; j++)       
			                                            if(x+_localctx.arrayOut.get(j) == 2020){
			                                             result = x * _localctx.arrayOut.get(j);
			                                            System.out.println("X: " +x+ " + Y: "+_localctx.arrayOut.get(j) + " = 2020" );
			                                            System.out.println("X: " +x+ " * Y: "+_localctx.arrayOut.get(j) + " = "+result );
			                                            }
			                                    }                                                                      
