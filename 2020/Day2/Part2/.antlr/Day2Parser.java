	...
	public final PasswordContext password(List <Integer> resultIn) throws RecognitionException {
		...
		try {
			...
			((PasswordContext)_localctx).pass = match(WORD);
			                                            ...
			                                            int count=0;
			                                            int lowerBound= (((PasswordContext)_localctx).n1!=null?Integer.valueOf(((PasswordContext)_localctx).n1.getText()):0)-1;
			                                            int upperBound= (((PasswordContext)_localctx).n2!=null?Integer.valueOf(((PasswordContext)_localctx).n2.getText()):0)-1;
